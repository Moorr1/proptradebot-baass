...
// Web + Agent step 2: versioned ladder settings (settings_api.js).
const { mountSettingsApi } = require('./settings_api');
mountSettingsApi(app, pool, { requireApiKey, auth: clerkAuth });
